 ...
 * @since 2.3.0
 */
import { Applicative, Applicative1 } from 'fp-ts/Applicative.ts'
import * as RA from 'fp-ts/ReadonlyArray.ts'
import * as RNEA from 'fp-ts/ReadonlyNonEmptyArray.ts'
import * as RR from 'fp-ts/ReadonlyRecord.ts'
import { constant, flow, identity, Predicate } from 'fp-ts/function.ts'
...
import { NonEmptyArray } from 'fp-ts/NonEmptyArray.ts'
import { URI as IURI } from 'fp-ts/Identity.ts'
